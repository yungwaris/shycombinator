...
export default function TruthSerum() {
  ...
  const handleAnalyze = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMsg(`Connection broken: ${errorMessage}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <main className="min-h-[100dvh] bg-white font-sans">
        ...
        {!loading && !results && (
          <>
            ...
            <form onSubmit={handleAnalyze} noValidate className="form-container">
              ...
              {errorMsg && (
                <div className="text-[13px] text-red-500 dc-font-mono mt-2 bg-red-50 p-2 border border-red-200 rounded z-10 relative">
                  {errorMsg}
                </div>
              )}

              <button type="submit" disabled={loading} className="submit-btn z-10 relative">
